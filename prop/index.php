    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Find A <span class="text-primary">Perfect Accommodation</span> For
                        NSBM Students</h1>
                    <p class="animated fadeIn mb-4 pb-2">Welcome to Accommodation Listings! Choose from a wide range of properties according to your needs.</p>
                    <a href="property-list.php" class="btn btn-primary py-3 px-5 me-3 animated fadeIn">Browse Now</a>
                </div>
                <div class="col-md-6 animated fadeIn">
                    <div class="owl-carousel header-carousel">
                        <div class="owl-carousel-item">
                            <img class="img-fluid" src="img/nsbm2.jpg" alt="">
                        </div>
                        <div class="owl-carousel-item">
                            <img class="img-fluid" src="img/nsbm.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-0 gx-5 align-items-end">
                    <div class="col-lg-6">
                        <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                            ...
                            <p>Choose from a wide range of Accommodation</p>
                        </div>
                    </div>
                </div>
        ...
        <div
            ...
            <div>
                ...
                <a href="https://www.nsbm.ac.lk/" class="text-white me-4">
