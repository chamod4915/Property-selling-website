        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">My Bookings</h1>
                    <nav aria-label="breadcrumb animated fadeIn">
                        <ol class="breadcrumb text-uppercase">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item"><a href="#">Pages</a></li>
                            <li class="breadcrumb-item text-body active" aria-current="page">My Bookings</li>
                        </ol>
                    </nav>
                    <?php                    
                ...
                <div class="row g-0 gx-5 align-items-end">
                    <div class="col-lg-6">
                        <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                            <h1 class="mb-3">My House Tour Booking History</h1>
                            <p>Recent house tour bookings</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="property-item rounded overflow-hidden">
                                    ...
                                    <div class="p-4 pb-0">
                                        ...
                                        <p><i class="fa fa-info-circle text-primary me-2"></i>Booking Description:
                                            <?php echo htmlentities($result->message);?></p>
                                        <p><i class="fa fa-calendar text-primary me-2"></i>Inspection Date:
                                    ...
                                    <div class="d-flex border-top">
                                        <small class="flex-fill text-center border-end py-2"><i
                                                class="fa fa-ruler-horizontal text-primary me-2"></i><?php echo htmlentities($result->squarefeet);?></small>
                                        <small class="flex-fill text-center border-end py-2"><i
                                                class="fa fa-bed text-primary me-2"></i><?php echo htmlentities($result->nobeds);?></small>
                                        <small class="flex-fill text-center py-2"><i
                                                class="fa fa-bath text-primary me-2"></i><?php echo htmlentities($result->nobathrooms);?></small>
                                    </div>
                                </div>
                            </div>
