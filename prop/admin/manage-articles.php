                ...
                <div class="navbar-nav w-100">
                    <a href="dashboard.php" class="nav-item nav-link"><i
                            ...
                            <?php if(isset($_SESSION['AdminUserType']) && $_SESSION['AdminUserType'] != 'Landlord') { ?>
                                ...
                                Users</a>
                                <a href="manage-articles.php" class="nav-item nav-link active"><i class="fa fa-users me-2"></i>Manage
                                Articles</a>
                            <?php } ?>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Manage Articles</h6>
                        <button type="button" onclick="window.location.href='add-article.php'"
                            class="btn btn-success m-2">Add New Article</button>
                    </div>
                </div>
                <?php                    
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    {               ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="editarticle.php?uid=<?php echo htmlentities($result->id);?>"
                                                    class="edit" title="Edit" data-toggle="tooltip"><i
                                                        class="fa fa-pen"></i></a>
                                                <a href="includes/deletearticle.php?uid=<?php echo htmlentities($result->id);?>"
