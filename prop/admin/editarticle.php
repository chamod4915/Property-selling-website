                        ...
                        <div class="col-lg-10 col-xl-9 mx-auto">
                            <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
                                ...
                                <div class="card-body p-4 p-sm-5">
                                    ...
                                    <form
                                        action="includes/articleHandler.php?uid=<?php echo htmlentities(intval($_GET['uid']));?>"
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="content"
                                                value="<?php echo htmlentities($result->content);?>" required>
                                            <label>Content</label>
                                        </div>

                                        <img src="includes/uploads/<?php echo htmlentities($result->image);?>" class="img-fluid mb-3" width="100%" alt="Article Image">
